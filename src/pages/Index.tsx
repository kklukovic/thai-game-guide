...
const casinos = [
  {
    ...
    features: ["รองรับ PromptPay ทุกธนาคาร", "ถอนเงินไม่จำกัดต่อวัน", "เน้นสล็อต PG Soft"],
  ...
  },
  {
    ...
    pimNote:
      "ห้ามพลาดเลยค่ะ! ตอนนี้ Roll88 มีอีเวนต์พิเศษจากค่าย JILI ลุ้นรางวัลรวม 5 ล้านบาท พิมคัดมาให้แล้ว 10 เกมที่แตกง่ายที่สุด",
    paymentMethods: ["promptpay", "bank"] as const,
    buttonText: "ทางเข้าเล่น",
  ...
  },
  {
    ...
    pimNote:
      "12Play เป็นแบรนด์ที่อยู่ในวงการมานานค่ะ พิมชอบที่ระบบความปลอดภัยแน่นมาก โบนัสต้อนรับ 2,088 บาทก็จัดเต็มสำหรับสมาชิกใหม่",
    paymentMethods: ["promptpay", "bank"] as const,
    buttonText: "ทางเข้าเล่น",
  ...
  },
  {
    ...
    features: ["ถอนเงินเป็นคริปโตทันที", "ไม่ต้องส่งเอกสารยืนยันตัวตน", "ถอนเงินได้จริงไม่มีเงื่อนไขซับซ้อน"],
  ...
  },
  {
    ...
    features: ["ย้ายค่ายรับสถานะ VIP ทันที", "มี Account Manager ส่วนตัว", "ลิมิตการถอนสูงมาก"],
