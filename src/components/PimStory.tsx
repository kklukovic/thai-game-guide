        ...
        <div className="mt-7 grid gap-3 sm:grid-cols-2">
          <div className="rounded-2xl border border-border bg-[#fbf7ef] p-4">
            <div className="flex items-center gap-2 text-[#2f7658]">
              ...
              <span className="font-display text-sm font-medium">อ่านง่ายก่อน</span>
            </div>
            <p className="mt-2 font-thai text-[12px] leading-5 text-muted-foreground">ไม่ยัดข้อมูลทุกอย่างไว้ในที่เดียว</p>
          </div>

          <div className="rounded-2xl border border-border bg-[#fbf7ef] p-4">
            <div className="flex items-center gap-2 text-[#9b5f1a]">
              <Heart className="h-4 w-4" />
              <span className="font-display text-sm font-medium">อัปเดตแบบคนจริง</span>
            </div>
            <p className="mt-2 font-thai text-[12px] leading-5 text-muted-foreground">แก้ทีละอย่างเมื่อข้อมูลเปลี่ยน ไม่ทำให้รก</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="relative overflow-hidden rounded-[28px] border border-white/10 bg-[#102538] p-6 text-white shadow-[0_28px_70px_-42px_rgba(4,25,42,.75)] sm:p-8 md:p-10">
      ...
      <div className="relative z-10 flex h-full flex-col">
        ...
        <div className="mt-auto pt-8">
          ...
          <p className="mt-4 font-thai text-[11px] leading-5 text-white/40">เปิดใน Telegram · กลุ่มภาษาไทย</p>
        </div>
      </div>
    </div>
  </section>
