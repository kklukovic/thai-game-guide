      ...
      >
        ...
        {isEvent && eventTitle && (
          <div className="mb-4 -mx-6 -mt-6 px-6 py-3 bg-gradient-to-r from-red-500 to-orange-500 text-white">
            ...
            {eventPeriod && <p className="text-xs text-center mt-1 opacity-90 font-thai">{eventPeriod}</p>}
          </div>
        )}
        ...
        <div className="flex items-start justify-between gap-4 mb-4">
          <div className="flex items-center gap-3">
            {/* Casino Logo */}
            <div
              className={`w-16 h-16 rounded-xl flex items-center justify-center overflow-hidden flex-shrink-0 border border-border ${
                logoBgDark ? "bg-foreground" : "bg-muted/50"
              }`}
            >
